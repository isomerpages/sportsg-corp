...
For a list of CCE programmes organised or publicized by CoachSG, please refer to (a) CoachSG Facebook and (b) NROC coaches' Electronic Direct Mailer (EDM).
...
Those with \* are newly added activities while the rest are already printed in the NROC log book.
